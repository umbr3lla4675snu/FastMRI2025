...
from utils.learning.train_dual_input_nafnet import train_dual_input_nafnet_standalone
...
def parse():
    parser = argparse.ArgumentParser(description='Train dual Input NAFNet for FastMRI enhancement',
    ...
    parser.add_argument('-l', '--lr', type=float, default=1e-4, help='Learning rate for dual Input NAFNet')
    parser.add_argument('-r', '--report-interval', type=int, default=100, help='Report interval')
    parser.add_argument('-n', '--net-name', type=Path, default='dual_input_nafnet', help='Name of network')
    ...
    # dual Input NAFNet architecture parameters
    parser.add_argument('--nafnet-width', type=int, default=32, help='dual Input NAFNet width (base channels)')
    parser.add_argument('--nafnet-middle-blks', type=int, default=8, help='Number of middle blocks in dual Input NAFNet')
...
if __name__ == '__main__':
    ...
    print(f"dual Input NAFNet architecture: width={args.nafnet_width}, middle_blks={args.nafnet_middle_blks}")
    ...
    print("Training dual Input NAFNet (VarNet frozen)")
    train_dual_input_nafnet_standalone(args)
